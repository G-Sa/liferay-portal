...
import {HeadlessInstanceApiHelper} from './HeadlessInstanceApiHelper';
...
export class ApiHelpers {
	...
	readonly headlessInstance: HeadlessInstanceApiHelper;
	...
	constructor(page: Page) {
		...
		this.headlessInstance = new HeadlessInstanceApiHelper(this);
